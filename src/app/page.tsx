    ...
    <>
      ...
      <main>
          ...
          <div className="shell relative grid items-center gap-14 py-14 sm:py-20 lg:grid-cols-[minmax(0,1fr)_minmax(0,44%)] lg:gap-16 lg:py-24 2xl:py-28">
            <Reveal>
              ...
              <h1 className="mt-6 text-[2.1rem] font-bold leading-[1.08] tracking-tight sm:text-5xl lg:text-6xl 2xl:text-[4.2rem]">
                Getting your business online should not{" "}
              ...
              <p className="mt-7 max-w-xl text-base leading-relaxed text-slate-600 sm:text-lg 2xl:text-xl">
                A website, an online store, a portfolio, a Facebook page, a
                YouTube channel — set up properly and priced for a shop, a tutor
                or a clinic, not for a corporate budget. That is the whole idea
                behind Nexvora.
              </p>
        ...
        >
          ...
          />
          <div className="shell relative grid gap-12 py-16 sm:py-20 lg:grid-cols-2 lg:gap-16 2xl:py-24">
            <Reveal className="max-w-2xl">
              ...
              <div className="mt-8 overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white p-2 shadow-lift">
                <Image
                  src="/mission-shop.jpg"
                  alt="A shop owner standing outside his shop"
                  width={1000}
                  height={780}
                  className="h-56 w-full rounded-[1.4rem] object-cover sm:h-72"
                />
              </div>
